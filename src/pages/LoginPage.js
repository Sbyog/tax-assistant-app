          ...
          <div className="animate-fadeIn">
            ...
            <div className="mb-8 bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20">
              <div className="transition-all duration-500 ease-in-out" key={featureIndex}>
                <div className="flex items-center mb-3">
                  <span className="text-3xl mr-3">{featuresData[featureIndex].icon}</span>
                  <h4 className="text-xl font-bold text-white">{featuresData[featureIndex].title}</h4>
                </div>
                <p className="text-blue-100 pl-12">{featuresData[featureIndex].description}</p>
              </div>
