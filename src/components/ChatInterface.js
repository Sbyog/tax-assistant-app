          ...
          <div className="flex items-center">
            {user?.photoURL ? (
              <img 
                ...
                onError={(e) => e.target.parentElement.parentElement.classList.remove('flex')}
              />
            ) : (
          ...
          <div className={`absolute top-0 left-0 right-0 z-10 py-4 px-5 border-b border-gray-200 dark:border-gray-600 flex items-center bg-white dark:bg-gray-750 ${currentUser && isPanelOpen ? 'rounded-tr-lg' : 'rounded-t-lg'}`}>
            <div className="flex items-center flex-1">
              ...
              <div className="flex items-center">
                ...
                <h2 className="text-lg font-semibold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-400 dark:to-blue-600">Your MATE</h2>
              </div>
            </div>
                    ...
                    {user?.photoURL && (
                      <div className="mr-2">
                        <img 
                          src={user.photoURL} 
                          alt="Profile" 
                          className="h-6 w-6 rounded-full border border-blue-200 dark:border-blue-700" 
